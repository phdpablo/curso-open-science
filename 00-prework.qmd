...
Os resumos das bibliografias que apresento em cada uma das seções foram elaborados com o auxílio do ChatGPT 4, seja pelo o [webapp da OpenAI](https://chat.openai.com/) ou pelo [Copilot](https://copilot.microsoft.com/) (ou buscador Bing) da Microsoft.
